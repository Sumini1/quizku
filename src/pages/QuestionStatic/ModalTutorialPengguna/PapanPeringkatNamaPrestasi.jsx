...
import TabelPekanIni from "../../ButtonMobile/PapanPeringkatPage/TabelPekanIni";
import TabelPekanIniDonatur from "../../ButtonMobile/PapanPeringkatPage/TabelPekanIniDonatur";
import ButtonNavbar from "../../../Components/ListButton/ButtonNavbar";
import { useSelector, useDispatch } from "react-redux";

import TutorialNamaPrestasi from "./TutorialNamaPrestasi";

const PapanPeringkatNamaPrestasi = () => {
    ...
    <div className="flex flex-col min-h-screen w-full h-full">
      ...
      >
        ...
        <div className="fixed bottom-0 w-full">
          <ButtonNavbar className="p-0 m-0 bg-blue-500 text-white flex justify-center items-center h-12" />
        </div>
      </div>
    </div>
  );
...
export default PapanPeringkatNamaPrestasi;
