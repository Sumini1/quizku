...
import Tutorial6 from "../ModalQuestions/Tutorial6";
import HumbergerMenu from "../../../Components/ModalTheme/HumbergerMenu";
import lamp from "../../../assets/questionStatic/lamp.png";
...
const PageEnam = () => {
  ...
  return (
    <div className="flex flex-col p-5 h-screen overflow-hidden md:justify-start md:items-start md:ml-10 md:py-10">
      <HumbergerMenu isOpen={isHumbergerOpen} />
      ...
      <div>
        <div className="flex flex-col mt-10">
          <h1 className="text-lg font-medium">Apa arti dari ihsan ?</h1>
        </div>
        <div className="flex flex-col   gap-5 mt-10 ">
          {[
            "Ihsan adalah iman kepada malaikat",
            "Ihsan adalah membaca Al-Qur'an",
            "Ihsan adalah belajar hadits",
