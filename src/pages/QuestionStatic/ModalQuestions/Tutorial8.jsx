...
import { IoArrowForward, IoDiamond } from "react-icons/io5";
...
const Tutorial8 = () => {
  ...
  const handleClick = () => {
    ...
    navigate("/page-sembilan"); // Pindah ke halaman 2
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center items-center p-5">
      ...
      <div className=" bg-white p-3 fixed top-44 w-[250px] rounded-lg shadow-md text-sm text-gray-800   ">
        {/* Konten Informasi */}
