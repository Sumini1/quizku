...
import gambar from "../../../../assets/beranda/gambar1.png";

const DasarIslamKeimanan = () => {
    const Navigate = useNavigate();
  const { getBorderColor, getButtonClass, getBorder, getTextTitle1, middleTheme } =
    useTheme();
  return (
    <div className="flex flex-col min-h-screen w-full h-full">
      ...
      >
        <div onClick={() => Navigate(-1)} className="flex gap-2 items-center mt-2">
          <FaArrowLeft className="items-center flex text-xl" />
          <h1 className="font-semibold text-xl items-center flex ">
            Materi Terbaru
          </h1>
        </div>
        ...
        <div className="flex flex-col mt-5">
          ...
          <div className="text-sm font-normal mt-3 gap-5 gap-y-3 flex flex-col">
            ...
            <p>
              ...
              <span className={`underline ${getTextTitle1()} mx-1 ml-1`}>
                kitab-kitab-Nya,
              </span>
