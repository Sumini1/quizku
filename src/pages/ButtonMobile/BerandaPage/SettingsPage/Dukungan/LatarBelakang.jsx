...
const LatarBelakang = () => {
  ...
  const latar = [
    {
      ...
      description: "Tujuan aplikasi dibangun",
      image: <img src={latar1} alt="latar" />,
    },
    {
      id: 2,
      name: "Visi dan Misi",
  ...
  return (
    <div className="flex flex-col min-h-screen w-full h-full">
      ...
      >
        <div className="flex flex-col p-5 overflow-y-auto scroll-auto">
          <div onClick={() => navigate(-1)} className="flex gap-2 items-center">
            <FaArrowLeft
              className="w-[20px] h-[20px] cursor-pointer"
              onClick={() => navigate(-1)}
            />
            <h1 className="text-xl font-semibold">Latar Belakang</h1>
          </div>
