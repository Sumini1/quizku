  ...
  return (
    <div className="flex flex-col min-h-screen w-full h-full">
      ...
      >
        ...
        {/* Content */}
        <div className="flex flex-col bg-[#DCE6F8] p-5  flex-grow">
        ...
        {/* Button */}
        <div className="bg-white md:bg-[#DCE6F8] text-base font-medium flex justify-between gap-4 p-5">
          <button
            onClick={() => navigate("/data-diri-lanjutan")}
